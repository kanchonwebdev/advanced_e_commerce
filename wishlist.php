...
<body>
    ...
    <div class="link-show">
        <div class="link-show-container">
            <a href="#">Home</a> > <a href="#">Shop</a> > <a href="#">Single Product</a> > <a href="#">Whishlist</a>
        </div>
    </div>
        ...
        <div class="cart-container">
            ...
            <div class="cart-header">
                <div class="cart-header-header">
                    ...
                    <div class="cart-header-header-block"><a href="#">Action</a></div>
                </div>

                <?php 
                    for($i = 0; $i < count($wish_session_arr_key); $i++){ 
                        $j = $wish_session_arr_key[$i];
                ?>
                    <div class="cart-header-footer">
                        <div class="cart-header-footer-block"><?php echo $_SESSION["wish_session_arr"][$j][1] ?></div>
                        <div class="cart-header-footer-block"><?php echo $_SESSION["wish_session_arr"][$j][3] ?></div>
                        <div class="cart-header-footer-block"><?php echo $_SESSION["wish_session_arr"][$j][7] ?></div>
                        <div class="cart-header-footer-block">$<?php echo $_SESSION["wish_session_arr"][$j][3] ?> X <?php echo $_SESSION["wish_session_arr"][$j][7] ?></div>
                        <div class="cart-header-footer-block"><a href="remove_cart.php?arr_id=<?php echo $j; ?>" class="remove-btn">Remove</a> <a href="add_cart.php?arr_id=<?php echo $j; ?>" class="update-btn">Add to Cart</a></div>
                    </div>
                <?php } ?>
            </div>
