...
<body>
    ...
    <div class="link-show">
        <div class="link-show-container">
            <a href="#">Home</a> > <a href="#">Track Order</a>
        </div>
    </div>
            ...
            <div class="cart-header">
                <div class="track-order">
                    <div class="track-order-block">
                        <input type="text" name="" id="" placeholder="Order ID" class="track-order-text-field">
                    </div>
                    
                    <div class="track-order-block">
                        <input type="text" name="" id="" placeholder="Billing Email" class="track-order-text-field">
                    </div>
                ...
                <div class="cart-header-footer">
                    ...
                    <div class="cart-header-footer-block"><a href="#">View</a></div>
                </div>
            </div>
        </div>
    </div>
