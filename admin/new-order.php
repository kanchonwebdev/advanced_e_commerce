<?php
    ...
    $data = $mn_query->select_distinct_order_id();
?>
        ...
        <div class="admin-right">
            ...
            <div class="new-order">
                <div class="new-order-header">
                    <div class="new-order-header-block">Order ID</div>

                    <div class="new-order-header-block">Order Date</div>
                ...
                <?php foreach($data as $result){ ?>
                    <div class="new-order-content">
                        <div class="new-order-block"><?php echo $result['order_id'] ?></div>

                        <div class="new-order-block">10/02/2021</div>

                        <div class="new-order-block"><a href="new-order-details.php?order_id=<?php echo $result['order_id'] ?>">VIEW</a></div>
                    </div>
                <?php } ?>
            </div>
        </div>
