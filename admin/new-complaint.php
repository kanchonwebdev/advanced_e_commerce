        ...
        <div class="admin-right">
            ...
            <div class="new-order">
                <div class="new-order-header">
                    <div class="new-order-header-block">Complaint Subject</div>

                    <div class="new-order-header-block">Register Date</div>

                    <div class="new-order-header-block">Action</div>
                </div>

                <div class="new-order-content">
                    <div class="new-order-block">IT issue</div>

                    <div class="new-order-block">10/02/2021</div>

                    <div class="new-order-block"><a href="#">VIEW</a></div>
                </div>
