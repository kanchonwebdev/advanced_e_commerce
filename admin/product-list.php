...
<body>
    ...
    <div class="admin">
        ...
        <div class="admin-right">
            ...
            <div class="admin-product-list-content">
                <div class="admin-product-list-block-header">
                    <div class="admin-product-list-content-block">Product Img</div>
                    <div class="admin-product-list-content-block">Product Name</div>
                    <div class="admin-product-list-content-block">Product Description</div>
                    <div class="admin-product-list-content-block">Product Quantity</div>
                    <div class="admin-product-list-content-block">Action</div>
                </div>

                <?php foreach ($data as $row) {?>
                    <hr>
                    <div class="admin-product-list-block-header">
                        <div class="admin-product-list-content-block"><img class="product-list-img" src="upload_image/<?php echo $row['p_image'] ?>"
                                width="100%" height="100%" alt=""></div>
                        <div class="admin-product-list-content-block"><?php echo $row['p_name'] ?></div>
                        <div class="admin-product-list-content-block">Lorem ipsum dolor sit lorem ipsum</div>
                        <div class="admin-product-list-content-block">In Stock</div>
                        <div class="admin-product-list-content-block"><a href="single-product.php?product_id=<?php echo $row['p_id'] ?>">Edit</a> <a href="single-product.php?product_id=<?php echo $row['p_id'] ?>">Delete</a></div>
                    </div>
                <?php } ?>
            </div>
